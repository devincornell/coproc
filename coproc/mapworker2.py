...
@dataclasses.dataclass
class MapWorkerProcess2(BaseWorkerProcess, typing.Generic[SendPayloadType, RecvPayloadType]):
...
#        
#    def send_slice(self, ind: slice):
#        '''Send a single data message.'''
#        self.messenger.send_request(SliceMessage(ind))
