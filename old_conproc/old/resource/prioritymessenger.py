...
class PriorityMessenger:
    ...
    @classmethod
    def dummy_pair(cls, message_prioritizer: typing.Callable[[BaseMessage], MessagePriority]) -> typing.Tuple[PriorityMessenger, PriorityMessenger]:
        p1, p2 = multiprocessing.Pipe(duplex=True)
        return PriorityMessenger(p1, message_prioritizer), PriorityMessenger(p2, message_prioritizer)
